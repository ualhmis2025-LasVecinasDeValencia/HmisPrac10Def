...
public class RegistroIncorrectoUsuarioYaExisteTest {
...
//    
  ...
  @Test
  public void registroIncorrectoUsuarioYaExiste() {
    ...
    assertThat(driver.findElement(By.cssSelector("vaadin-notification-card")).getText(), is("El usuario ya existe"));
  }
}
