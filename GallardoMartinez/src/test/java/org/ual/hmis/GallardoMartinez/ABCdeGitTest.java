...
public class ABCdeGitTest {
  ...
  public void aBCdeGit() {
    ...
    wait.until(ExpectedConditions.elementToBeClickable(By.linkText("ABC de Git")));
    driver.findElement(By.linkText("ABC de Git")).click();

    wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".post-title")));
    assertThat(driver.findElement(By.cssSelector(".post-title")).getText(), is("ABC de Git"));
  }
}
