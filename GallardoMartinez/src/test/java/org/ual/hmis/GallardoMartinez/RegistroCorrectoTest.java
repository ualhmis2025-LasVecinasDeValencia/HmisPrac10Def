...
//    driver = new FirefoxDriver(firefoxOptions);
  ...
  public void registroCorrecto() {
    driver.get("https://my-app-1748620076153.azurewebsites.net/registro");
    ...
    vars.put("username", js.executeScript("return 'user_' + Date.now();"));
    driver.findElement(By.id("input-vaadin-text-field-7")).sendKeys(vars.get("username").toString());
    ...
    vars.put("password", js.executeScript("return 'pass_' + Math.floor(Math.random() * 1000000);"));
    driver.findElement(By.id("input-vaadin-password-field-8")).sendKeys(vars.get("password").toString());

    wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("vaadin-button")));
    ...
    assertThat(driver.findElement(By.cssSelector("vaadin-notification-card")).getText(), is("Usuario registrado correctamente"));
  }
}
