...
public class LoginIncorrectoUsuarioNoEncontradoTest {
...
//	    
  ...
  @Test
  public void loginIncorrectoUsuarioNoEncontrado() {
    // Test name: LoginIncorrectoUsuarioNoEncontrado
    ...
    // 4 | type | id=input-vaadin-text-field-7 | UsuarioNoExistente
    driver.findElement(By.id("input-vaadin-text-field-7")).sendKeys("UsuarioNoExistente");
    // 5 | click | id=input-vaadin-password-field-8 | 
    ...
    // 6 | type | id=input-vaadin-password-field-8 | ContrasenaNoExistente
    driver.findElement(By.id("input-vaadin-password-field-8")).sendKeys("ContrasenaNoExistente");
    // 7 | click | css=vaadin-button:nth-child(2) | 
